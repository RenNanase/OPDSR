<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white leading-tight">
            {{ __('Visiting Consultant Daily Log') }}
        </h2>
    </x-slot>
                        ...
                        <div class="mt-6 border-t border-gray-200 pt-6">
                            ...
                            <div class="mt-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <x-input-label for="new_male_count_vs" :value="__('New Male Patients')" />
                                        <x-text-input id="new_male_count_vs" class="block mt-1 w-full" type="number" name="new_male_count_vs" :value="old('new_male_count_vs', 0)" min="0" required />
                                        <x-input-error :messages="$errors->get('new_male_count_vs')" class="mt-2" />
                                    </div>

                                    <div>
                                        <x-input-label for="new_female_count_vs" :value="__('New Female Patients')" />
                                        <x-text-input id="new_female_count_vs" class="block mt-1 w-full" type="number" name="new_female_count_vs" :value="old('new_female_count_vs', 0)" min="0" required />
