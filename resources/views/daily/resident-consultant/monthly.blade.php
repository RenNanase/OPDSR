<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Resident Consultant Monthly Logs')}}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6">
                     <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <form action="{{ route('daily.resident-consultant.monthly') }}" method="GET" class="flex items-center space-x-4">
                            <div>
                                    ...
                                    <div style="background-color: #afeeee" class="px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                        ...
                                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                            <div class="grid grid-cols-2 gap-4">
                                                <div class="flex items-center gap-2">
                                                    <span>Male:</span>
                                                    <span class="font-semibold">{{ $monthlyStats['new_male_count'] ?? 0 }}</span>
                                                </div>
                                                <div class="flex items-center gap-2">
                                                    <span>Female:</span>
                                                    <span class="font-semibold">{{ $monthlyStats['new_female_count'] ?? 0 }}</span>
                                                </div>
                                            </div>
                                        </dd>
                                    </div>
