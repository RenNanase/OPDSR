            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                            ...
                            <dl>
                                ...
                                @if($entry->patients->isNotEmpty())
                                    ...
                                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                        ...
                                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                            <ul class="list-disc list-inside">
                                                <li>Male: {{ $entry->patients->first()->new_male_count_vs ?? 0 }}</li>
                                                <li>Female: {{ $entry->patients->first()->new_female_count_vs ?? 0 }}</li>
                                            </ul>
                                        </dd>
                                    </div>
                                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <div class="mt-6 flex justify-end space-x-4">
                        ...
                        <a href="{{ route('daily.visiting-consultant.edit', $entry) }}" class="inline-flex items-center px-4 py-2 bg-[#87cefa] border border-transparent rounded-md font-semibold text-xs text-black uppercase tracking-widest hover:bg-[#ffd3dd] focus:bg-[#ffd3dd] active:bg-[#ffd3dd] focus:outline-none focus:ring-2 focus:ring-[#87cefa] focus:ring-offset-2 transition ease-in-out duration-150">
                            Edit Record
                        </a>
                    </div>
                </div>
