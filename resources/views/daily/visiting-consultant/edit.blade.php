<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Visiting Consultant Log') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('daily.visiting-consultant.update', $entry) }}" class="space-y-6" x-data="{
                        ...
                        newMaleCount: {{ old('new_male_count_vs', optional($entry->patients->first())->new_male_count_vs ?? 0) }},
                        newFemaleCount: {{ old('new_female_count_vs', optional($entry->patients->first())->new_female_count_vs ?? 0) }},
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="bg-white p-4 rounded-lg border border-gray-200">
                                    ...
                                    <div class="pt-4 border-t border-gray-200">
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                <x-input-label for="new_male_count_vs" :value="__('New Male')" />
                                                <x-text-input id="new_male_count_vs" name="new_male_count_vs" type="number" class="mt-1 block w-full" x-model="newMaleCount" min="0" required />
                                                <x-input-error class="mt-2" :messages="$errors->get('new_male_count_vs')" />
                                            </div>
                                            <div>
                                                <x-input-label for="new_female_count_vs" :value="__('New Female')" />
                                                <x-text-input id="new_female_count_vs" name="new_female_count_vs" type="number" class="mt-1 block w-full" x-model="newFemaleCount" min="0" required />
                                                <x-input-error class="mt-2" :messages="$errors->get('new_female_count_vs')" />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="mt-6 flex justify-end space-x-4">
                            <a href="{{ route('daily.visiting-consultant.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                                Cancel
                            </a>
                            <x-primary-button>
                                {{ __('Update Log') }}
