<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Visiting Consultant Daily Logs') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            <!-- Date Selection -->
                            <form action="{{ route('daily.visiting-consultant.index') }}" method="GET" class="flex items-center space-x-4">
                                <div>
                            ...
                            <div class="flex space-x-4">
                                <a href="{{ route('daily.visiting-consultant.monthly') }}"
                                ...
                                <a href="{{ route('daily.visiting-consultant.create') }}"
                                   class="inline-flex items-center px-4 py-2 bg-[#87cefa] border border-transparent rounded-md font-semibold text-xs text-black uppercase tracking-widest hover:bg-[#ffd3dd] focus:bg-[#ffd3dd] active:bg-[#ffd3dd] focus:outline-none focus:ring-2 focus:ring-[#87cefa] focus:ring-offset-2 transition ease-in-out duration-150">
                                    Add New Log
                                </a>
                            </div>
                                ...
                                <dl>
                                    ...
                                    <div class="bg-green-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                        ...
                                        <dd class="mt-1 text-sm text-green-900 sm:mt-0 sm:col-span-2 font-semibold">
                                            {{ ($dailyStats['new_male_count_vs'] ?? 0) + ($dailyStats['new_female_count_vs'] ?? 0) }}
                                        </dd>
                                    </div>
                                        ...
                                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                            <div class="space-y-1">
                                                ...
                                                <div class="mt-2 pt-2 border-t border-gray-200">
                                                    ...
                                                    <div>New Male: {{ $dailyStats['new_male_count_vs'] ?? 0 }}</div>
                                                    <div>New Female: {{ $dailyStats['new_female_count_vs'] ?? 0 }}</div>
                                                </div>
                                                <div class="mt-2 pt-2 border-t border-gray-200">
                                ...
                                @forelse($loggedEntries as $log)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center font-medium">
                                            <a href="{{ route('daily.visiting-consultant.show', $log) }}" class="text-[#87cefa] hover:text-[#ffd3dd]">
                                                {{ __('View Details') }}
                                            </a>
                                        </td>
                                    </tr>
