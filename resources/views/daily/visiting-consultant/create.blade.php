<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('New Visiting Consultant Log Entry') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('daily.visiting-consultant.store') }}" x-data="{
                        ...
                        newMaleCount: {{ old('new_male_count_vs', 0) }},
                        newFemaleCount: {{ old('new_female_count_vs', 0) }},
                        ...
                        <div>
                            ...
                            <x-text-input id="date" class="block mt-1 w-full" type="date" name="date" :value="old('date', $selectedDate)" required @change="window.location.href = '{{ route('daily.visiting-consultant.create') }}?date=' + $event.target.value" />
                                    ...
                                    <div class="pt-4 border-t border-gray-200">
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <x-text-input id="new_male_count_vs" class="block mt-1 w-full" type="number" name="new_male_count_vs" x-model="newMaleCount" min="0" />
                                                <x-input-error :messages="$errors->get('new_male_count_vs')" class="mt-2" />
                                            </div>
                                            <div>
                                                <x-input-label for="new_female_count_vs" :value="__('New Female')" />
                                                <x-text-input id="new_female_count_vs" class="block mt-1 w-full" type="number" name="new_female_count_vs" x-model="newFemaleCount" min="0" />
                                                <x-input-error :messages="$errors->get('new_female_count_vs')" class="mt-2" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
