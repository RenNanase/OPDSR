<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('New Wing Medical Procedures') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6">
                        ...
                        <form method="GET" action="{{ route('annual.new-wing.index') }}" class="flex items-center space-x-4">
                            ...
                            <x-primary-button>
                                {{ __('View') }}
                                               ...
                                               <div class="flex space-x-4">
                                                <a href="{{  route('annual.new-wing.daily') }}"
                                                ...
                                                <a href="{{  route('annual.new-wing.monthly') }}"
                                                   class="inline-flex items-center px-4 py-2 bg-[#87cefa] border border-transparent rounded-md font-semibold text-xs text-black uppercase tracking-widest hover:bg-[#ffd3dd] focus:bg-[#ffd3dd] active:bg-[#ffd3dd] focus:outline-none focus:ring-2 focus:ring-[#87cefa] focus:ring-offset-2 transition ease-in-out duration-150">
                                                    Monthly Records
                                                </a>
                                            </div>
                    ...
                    @if($procedures)
                        ...
                        <div class="mb-6 p-4 bg-red-100 border border-red-400 text-red-700 rounded-lg">
                            <p class="text-sm">
                                This record already exists. To modify the data, please use the edit button on the Daily Records page.
                            </p>
                        </div>
                    @endif

                    <form method="POST" action="{{ route('annual.new-wing.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div>
                                ...
                                <x-text-input id="injection_vaccine" name="injection_vaccine" type="number" class="mt-1 block w-full"
                                    :value="old('injection_vaccine', $procedures?->injection_vaccine ?? 0)" required min="0"
                            ...
                            <div>
                                ...
                                <x-text-input id="iv_medication" name="iv_medication" type="number" class="mt-1 block w-full"
                                    :value="old('iv_medication', $procedures?->iv_medication ?? 0)" required min="0"
                                    :disabled="$procedures ? true : false" />
                            ...
                            <div>
                                ...
                                <x-text-input id="urea_blood_test" name="urea_blood_test" type="number" class="mt-1 block w-full"
                                    :value="old('urea_blood_test', $procedures?->urea_blood_test ?? 0)" required min="0"
                                    :disabled="$procedures ? true : false" />
                            ...
                            <div>
                                ...
                                <x-text-input id="venepuncture" name="venepuncture" type="number" class="mt-1 block w-full"
                                    :value="old('venepuncture', $procedures?->venepuncture ?? 0)" required min="0"
                                    :disabled="$procedures ? true : false" />
                            ...
                            <div>
                                ...
                                <x-text-input id="iv_cannulation" name="iv_cannulation" type="number" class="mt-1 block w-full"
                                    :value="old('iv_cannulation', $procedures?->iv_cannulation ?? 0)" required min="0"
                                    :disabled="$procedures ? true : false" />
                            ...
                            <div>
                                ...
                                <x-text-input id="swab_cs_nose_oral" name="swab_cs_nose_oral" type="number" class="mt-1 block w-full"
                                    :value="old('swab_cs_nose_oral', $procedures?->swab_cs_nose_oral ?? 0)" required min="0"
                                    :disabled="$procedures ? true : false" />
                            ...
                            <div>
                                ...
                                <x-text-input id="dressing" name="dressing" type="number" class="mt-1 block w-full"
                                    :value="old('dressing', $procedures?->dressing ?? 0)" required min="0"
                                    :disabled="$procedures ? true : false" />
                            ...
                            <div>
                                ...
                                <x-text-input id="ecg_12_led" name="ecg_12_led" type="number" class="mt-1 block w-full"
                                    :value="old('ecg_12_led', $procedures?->ecg_12_led ?? 0)" required min="0"
                                    :disabled="$procedures ? true : false" />
                            ...
                            <div>
                                ...
                                <x-text-input id="urinary_catheterization" name="urinary_catheterization" type="number" class="mt-1 block w-full"
                                    :value="old('urinary_catheterization', $procedures?->urinary_catheterization ?? 0)" required min="0"
                                    :disabled="$procedures ? true : false" />
                            ...
                            <div>
                                ...
                                <x-text-input id="ng_tube_insertion" name="ng_tube_insertion" type="number" class="mt-1 block w-full"
                                    :value="old('ng_tube_insertion', $procedures?->ng_tube_insertion ?? 0)" required min="0"
                                    :disabled="$procedures ? true : false" />
                            ...
                            <div>
                                ...
                                <x-text-input id="nebulization" name="nebulization" type="number" class="mt-1 block w-full"
                                    :value="old('nebulization', $procedures?->nebulization ?? 0)" required min="0"
                                    :disabled="$procedures ? true : false" />
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <x-primary-button :disabled="$procedures ? true : false">
                                {{ __('Save Procedures') }}
                            </x-primary-button>
                        </div>
                    </form>
