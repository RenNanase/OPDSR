<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('New Wing - Daily Medical Procedures') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6">
                        ...
                        <form method="GET" action="{{ route('annual.new-wing.daily') }}" class="flex items-center space-x-4">
                            ...
                            @if($procedures)
                                <a href="{{ route('annual.new-wing.edit', ['date' => $date]) }}"
                                    <x-primary-button>
                                        {{ __('Edit') }}
                                    </x-primary-button>
                                </a>
